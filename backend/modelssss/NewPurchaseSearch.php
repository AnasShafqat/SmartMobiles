...
class NewPurchaseSearch extends NewPurchase
{
    ...
    public function rules()
    {
        return [
            ...
            [['seller_name', 'globalSearch','date_of_purchase', 'cnic_front_pic', 'cnic_back_pic', 'cell_phone_front_pic', 'cell_phone_back_pic', 'cell_phone_brand', 'cell_phone_model', 'created_at', 'updated_at'], 'safe'],
        ];
    }
