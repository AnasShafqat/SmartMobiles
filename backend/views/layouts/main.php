...
<head>
    ...
    <link rel="shortcut icon" href="images/logo1.jpg" type="image/jpg">
    <?php $this->head() ?>
...
<div class="container body">
    ...
    <div class="main_container">
        ...
        <footer class="footer">
            <div class="container">
                <p align="center">Copyright &copy; <?php echo date("Y");?> All Rights Reserved By:  <a href="#" target="_blank" style="color:#449D44"><b>Smart Mobile</b></a>
                </p>
            </div>
        </footer>
        <!-- /footer content -->
